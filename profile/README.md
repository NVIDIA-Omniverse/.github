...
NVIDIA Omniverse is a collection of accelerated libraries, OpenUSD tooling, and sample repositories for developing Physical AI simulation applications and agentic workflows, tuned specially for robotics simulation, industrial digital twins, and synthetic data generation.
...
| [ovstage](https://github.com/NVIDIA-Omniverse/ovstage)                 | A C and Python library providing a shared, high-performance, vectorized, GPU-capable scene data substrate for OpenUSD data across Omniverse libraries (physics, rendering, sensors, and animation) with zero-copy DLPack tensor interchange.                                                   |
| [ovnewton](https://github.com/NVIDIA-Omniverse/ovnewton)               | Connects the [Newton](https://github.com/newton-physics/newton) physics engine to the Omniverse library ecosystem. It builds a Newton model from a USD scene populated into [ovstage](https://github.com/NVIDIA-Omniverse/ovstage), while the application owns the solver and simulation loop. |
...
- [omniverse-sil-bridge](https://github.com/NVIDIA-Omniverse/omniverse-sil-bridge): Omniverse gRPC bridge samples that show how to expose Omniverse libraries via OVSimDataAPI for multi-process/multi-node workflows
- [synthetic-data-examples](https://github.com/NVIDIA-Omniverse/synthetic-data-examples): synthetic data generation examples
- [streaming-self-hosted](https://github.com/NVIDIA-Omniverse/streaming-self-hosted): AI-agent skills and tooling to plan, deploy, and validate a self-hosted NVIDIA Omniverse Streaming on NVCF stack on AWS or Azure infrastructure
- [kit-app-template](https://github.com/NVIDIA-Omniverse/kit-app-template): Omniverse Kit App Template, for building a full Kit application when you need the app framework rather than a standalone library
...
- [usd-profiles-nvidia](https://github.com/NVIDIA-Omniverse/usd-profiles-nvidia): framework for defining and managing OpenUSD asset profiles, capabilities, and requirements (archived)
...
- [usd-content-agents](https://github.com/NVIDIA-Omniverse/usd-content-agents): AI-powered agents that analyze 3D assets and automate material assignment, physics property classification, and texture generation for USD files using Vision-Language Models (VLMs)
- [cae-openusd-plugins](https://github.com/NVIDIA-Omniverse/cae-openusd-plugins): OpenUSD schema libraries and SdfFileFormat adapters for CAE (Computer-Aided Engineering) scientific and simulation data
...
- [physical-ai-event-video-generation](https://github.com/NVIDIA/skills/tree/main/skills/physical-ai-event-video-generation)
- [physical-ai-image-attribute-augmentation](https://github.com/NVIDIA/skills/tree/main/skills/physical-ai-image-attribute-augmentation)
